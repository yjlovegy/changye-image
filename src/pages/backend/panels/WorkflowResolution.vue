...
<template>
  <section class="workflow-resolution" aria-label="默认生成尺寸">
    ...
    <div class="resolution-actions"><span v-if="saved" role="status">✓ 已保存</span><button type="button" class="bbi-btn bbi-btn-primary" :disabled="!validResolution(draft)" @click="save">保存为默认尺寸</button></div>
  </section>
</template>
<style scoped>
